...
function showRank() {
  ...
  contentEl.innerHTML = '<div class="result-screen" style="animation: fadeIn 1s ease-out;">' +
    '<h2 class="step-title" style="border:none; color:var(--success-color); font-size:2rem; margin-bottom: 30px;">MISSION ACCOMPLISHED</h2>' +
    '<div class="rank-text">RANK: S</div>' +
    '<div class="time-text" style="margin: 20px 0;">' +
    'TIME ELAPSED: <span style="color: var(--text-highlight); font-weight:bold;">' + minutes + 'm ' + seconds + 's</span>' +
    '</div>' +
    '<div style="color: #66b2b2; font-family:\'Share Tech Mono\'; font-size: 1.1rem; margin-top: 30px; border: 1px dashed rgba(0,255,255,0.3); padding: 15px;">' +
    '<p>> LOG_DATE: ' + dateStr + '</p>' +
    '<p>> LOG_TIME: ' + timeStr + '</p>' +
    '</div>' +
    '</div>';
